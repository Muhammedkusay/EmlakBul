@extends('layouts.main', ['user' => $user ?? '', 'title' => 'Favoriler'])

@section('content')

<div id="posts" class="w-full min-h-96 md:w-3/4 mx-auto p-4 md:p-0">
    <h3 class="text-4xl font-semibold pt-10">Favorilerim</h3>
    ...
    @else
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 py-12">
            {{-- list cards --}}
